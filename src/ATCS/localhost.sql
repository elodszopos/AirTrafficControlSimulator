...
--
-- Host: localhost
-- Generation Time: Nov 03, 2013 at 01:43 PM
...
-- Database: `atc`
--
CREATE DATABASE `atc` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `atc`;
...
CREATE TABLE IF NOT EXISTS `distances` (
  `STARTPORT` varchar(30) NOT NULL,
  `DESTPORT` varchar(30) NOT NULL,
  `DISTANCE` int(11) NOT NULL,
  KEY `STARTPORT` (`STARTPORT`,`DESTPORT`)
...
INSERT INTO `distances` (`STARTPORT`, `DESTPORT`, `DISTANCE`) VALUES
('Iasi', 'Bucuresti', 324),
('Cluj Napoca', 'Bucuresti', 325),
('Cluj Napoca', 'Iasi', 305),
('Targu Mures', 'Cluj Napoca', 79),
('Targu Mures', 'Iasi', 240),
('Targu Mures', 'Bucuresti', 263),
('Budapest', 'Bucuresti', 642),
('Budapest', 'Cluj Napoca', 352),
('Budapest', 'Targu Mures', 430),
('Budapest', 'Iasi', 642);
...
INSERT INTO `ports` (`CITY`, `CLIENT`, `TAKEN`, `HOST`) VALUES
('Iasi', 2345, 0, 'localhost'),
('Cluj Napoca', 2347, 0, 'localhost'),
('Targu Mures', 2349, 0, 'localhost'),
('Budapest', 2346, 0, 'localhost'),
('Bucuresti', 2348, 0, 'localhost');
--
...
('def', 'atc', 'distances', 'STARTPORT', 1, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'atc', 'distances', 'DESTPORT', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'atc', 'distances', 'DISTANCE', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'atc', 'ports', 'CITY', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'atc', 'ports', 'CLIENT', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'atc', 'ports', 'TAKEN', 3, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'atc', 'ports', 'HOST', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'laboratorydb', 'faculties', 'Code', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'laboratorydb', 'faculties', 'NameFac', 2, NULL, 'NO', 'tinytext', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'tinytext', '', '', 'select,insert,update,references', ''),
('def', 'laboratorydb', 'universities', 'Id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'laboratorydb', 'universities', 'NameUniv', 2, NULL, 'NO', 'tinytext', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'tinytext', '', '', 'select,insert,update,references', ''),
('def', 'laboratorydb', 'universities', 'City', 3, NULL, 'NO', 'tinytext', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'tinytext', '', '', 'select,insert,update,references', ''),
('def', 'laboratorydb', 'universities', 'Code', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(3)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bike_images', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bike_images', 'bikes_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bike_images', 'img', 3, NULL, 'NO', 'varchar', 1500, 1500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1500)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'users_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'username', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'firstname', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'lastname', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'model', 6, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'year', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'bikes', 'info', 8, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'motorbikes', 'users', 'admin', 2, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'users', 'firstname', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'users', 'lastname', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'users', 'username', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'motorbikes', 'users', 'password', 6, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
...
('def', 'startrek', 'crew', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'startrek', 'crew', 'name', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(25)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'startrek', 'crew', 'img', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'startrek', 'login', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'startrek', 'login', 'user', 2, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(15)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'startrek', 'login', 'pass', 3, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'startrek', 'login', 'level', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'startrek', 'service', 'crew_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'startrek', 'service', 'ship_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'startrek', 'service', 'cpt', 3, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'startrek', 'ships', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'startrek', 'ships', 'name', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(25)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'startrek', 'ships', 'class', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'startrek', 'ships', 'img', 4, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'bikes', 'bike_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'users', 'bikes', 'C_bike_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'bikes', 'member_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'bikes', 'model', 4, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'bikes', 'year', 5, NULL, 'NO', 'varchar', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'bikes', 'description', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'users', 'members', 'member_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'users', 'members', 'firstname', 2, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'members', 'lastname', 3, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'members', 'login', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'members', 'passwd', 5, NULL, 'NO', 'varchar', 32, 32, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'bike_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'shop_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'member_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'model', 4, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'year', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'email', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'users', 'shop', 'state', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_KEY', '56'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '57'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '3977'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FREE', '7790'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '6111'),
('INNODB_BUFFER_POOL_READS', '401'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '127'),
('INNODB_DATA_FSYNCS', '60'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8753152'),
('INNODB_DATA_READS', '411'),
('INNODB_DATA_WRITES', '103'),
('INNODB_DATA_WRITTEN', '1702400'),
('INNODB_DBLWR_PAGES_WRITTEN', '51'),
('INNODB_DBLWR_WRITES', '8'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '18'),
('INNODB_LOG_WRITES', '34'),
('INNODB_OS_LOG_FSYNCS', '44'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '26112'),
...
('INNODB_ROWS_READ', '388'),
('INNODB_ROWS_UPDATED', '16'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '26518'),
('UPTIME_SINCE_FLUSH_STATUS', '26518');
...
('DATADIR', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\data\\'),
...
('BASEDIR', 'C:/Program Files/wamp/bin/mysql/mysql5.5.24'),
...
('CHARACTER_SETS_DIR', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\share\\charsets\\'),
('LOG_BIN', 'ON'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\share\\'),
...
('PID_FILE', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\data\\x-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\data\\x-PC.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'C:\\Program Files\\wamp\\logs\\mysql.log'),
...
('PLUGIN_DIR', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'C:\\Program Files\\wamp\\bin\\mysql\\mysql5.5.24\\data\\x-PC-slow.log'),
...
('def', 'laboratorydb', 'PRIMARY', 'def', 'laboratorydb', 'faculties', 'Code', 1, NULL, NULL, NULL, NULL),
('def', 'laboratorydb', 'PRIMARY', 'def', 'laboratorydb', 'universities', 'Id', 1, NULL, NULL, NULL, NULL),
('def', 'laboratorydb', 'universities_ibfk_1', 'def', 'laboratorydb', 'universities', 'Code', 1, 1, 'laboratorydb', 'faculties', 'Code'),
('def', 'motorbikes', 'PRIMARY', 'def', 'motorbikes', 'bike_images', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'motorbikes', 'bike_images_ibfk_1', 'def', 'motorbikes', 'bike_images', 'bikes_id', 1, 1, 'motorbikes', 'bikes', 'id'),
('def', 'motorbikes', 'PRIMARY', 'def', 'motorbikes', 'bikes', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'motorbikes', 'bikes_ibfk_3', 'def', 'motorbikes', 'bikes', 'users_id', 1, 1, 'motorbikes', 'users', 'id'),
('def', 'motorbikes', 'PRIMARY', 'def', 'motorbikes', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'startrek', 'PRIMARY', 'def', 'startrek', 'crew', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'startrek', 'name', 'def', 'startrek', 'crew', 'name', 1, NULL, NULL, NULL, NULL),
('def', 'startrek', 'PRIMARY', 'def', 'startrek', 'login', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'startrek', 'user_2', 'def', 'startrek', 'login', 'user', 1, NULL, NULL, NULL, NULL),
('def', 'startrek', 'PRIMARY', 'def', 'startrek', 'ships', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'startrek', 'name', 'def', 'startrek', 'ships', 'name', 1, NULL, NULL, NULL, NULL),
('def', 'users', 'PRIMARY', 'def', 'users', 'bikes', 'bike_id', 1, NULL, NULL, NULL, NULL),
('def', 'users', 'PRIMARY', 'def', 'users', 'members', 'member_id', 1, NULL, NULL, NULL, NULL),
('def', 'users', 'PRIMARY', 'def', 'users', 'shop', 'bike_id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2013-11-03 13:43:41', NULL, NULL, NULL, '', '', NULL),
('def', 'atc', 'distances', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 862, 16384, NULL, 16384, 6291456, '2013-11-02 20:08:30', NULL, NULL, NULL, '', '', NULL),
('def', 'atc', 'ports', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 6291456, '2013-11-02 20:05:42', NULL, NULL, NULL, '', '', NULL),
('def', 'laboratorydb', 'faculties', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2013-03-23 20:58:46', NULL, NULL, NULL, '', '', NULL),
('def', 'laboratorydb', 'universities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2013-03-23 20:58:43', NULL, NULL, NULL, '', '', NULL),
('def', 'motorbikes', 'bike_images', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2013-11-02 17:02:58', NULL, NULL, NULL, '', '', NULL),
('def', 'motorbikes', 'bikes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 65536, 0, '2013-11-02 14:15:50', NULL, NULL, NULL, '', '', NULL),
('def', 'motorbikes', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2013-11-02 14:20:28', NULL, NULL, NULL, '', '', NULL),
...
('def', 'startrek', 'crew', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 51, 684, 281474976710655, 3072, 64, '2008-01-05 02:08:39', '2008-01-13 10:16:40', NULL, NULL, '', '', NULL),
('def', 'startrek', 'login', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 3072, 0, '2008-01-02 21:47:51', '2008-01-02 20:47:50', '2008-01-03 19:42:37', NULL, '', '', NULL),
('def', 'startrek', 'service', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19, 10, 190, 2814749767106559, 3072, 0, '2008-01-05 02:10:52', '2008-01-13 10:16:40', '2008-01-12 22:38:33', NULL, '', '', NULL),
('def', 'startrek', 'ships', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 62, 620, 281474976710655, 3072, 60, '2008-01-05 02:08:50', '2008-01-13 10:16:40', NULL, NULL, '', '', NULL),
('def', 'users', 'bikes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2013-03-10 14:01:26', NULL, NULL, NULL, '', '', NULL),
('def', 'users', 'members', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 1365, 16384, NULL, 0, 0, '2013-03-09 19:46:23', NULL, NULL, NULL, '', '', NULL),
('def', 'users', 'shop', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2013-03-10 07:30:47', NULL, NULL, NULL, '', '', NULL);
...
(32, 'root', 'localhost:21864', 'atc', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'laboratorydb', 'universities_ibfk_1', 'def', 'laboratorydb', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'universities', 'faculties'),
('def', 'motorbikes', 'bike_images_ibfk_1', 'def', 'motorbikes', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'bike_images', 'bikes'),
('def', 'motorbikes', 'bikes_ibfk_3', 'def', 'motorbikes', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'bikes', 'users');
...
('def', 'atc', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'laboratorydb', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'members', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'motorbikes', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'startrek', 'latin1', 'latin1_general_ci', NULL),
('def', 'test', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'users', 'latin1', 'latin1_swedish_ci', NULL);
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2313'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2358'),
('INNODB_BUFFER_POOL_PAGES_DATA', '411'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '102'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7781'),
('INNODB_BUFFER_POOL_PAGES_MISC', '0'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '6656'),
('INNODB_BUFFER_POOL_READS', '410'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '127'),
('INNODB_DATA_FSYNCS', '60'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '26519'),
('UPTIME_SINCE_FLUSH_STATUS', '26519');
...
('def', 'atc', 'distances', 1, 'atc', 'STARTPORT', 1, 'STARTPORT', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'atc', 'distances', 1, 'atc', 'STARTPORT', 2, 'DESTPORT', 'A', 19, NULL, NULL, '', 'BTREE', '', ''),
('def', 'laboratorydb', 'faculties', 0, 'laboratorydb', 'PRIMARY', 1, 'Code', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'laboratorydb', 'universities', 0, 'laboratorydb', 'PRIMARY', 1, 'Id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'laboratorydb', 'universities', 1, 'laboratorydb', 'Code', 1, 'Code', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bike_images', 0, 'motorbikes', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bike_images', 1, 'motorbikes', 'bikes_id', 1, 'bikes_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bikes', 0, 'motorbikes', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bikes', 1, 'motorbikes', 'username', 1, 'username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bikes', 1, 'motorbikes', 'username_2', 1, 'username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bikes', 1, 'motorbikes', 'username_3', 1, 'username', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'bikes', 1, 'motorbikes', 'users_id', 1, 'users_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'motorbikes', 'users', 0, 'motorbikes', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'startrek', 'crew', 0, 'startrek', 'PRIMARY', 1, 'id', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'crew', 0, 'startrek', 'name', 1, 'name', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'login', 0, 'startrek', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'login', 0, 'startrek', 'user_2', 1, 'user', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'service', 1, 'startrek', 'ship_id', 1, 'ship_id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'service', 1, 'startrek', 'crew_id', 1, 'crew_id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'ships', 0, 'startrek', 'PRIMARY', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'startrek', 'ships', 0, 'startrek', 'name', 1, 'name', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'users', 'bikes', 0, 'users', 'PRIMARY', 1, 'bike_id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'users', 'members', 0, 'users', 'PRIMARY', 1, 'member_id', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'users', 'shop', 0, 'users', 'PRIMARY', 1, 'bike_id', 'A', 6, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-03 13:43:41', '2013-11-03 13:43:41', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2013-11-03 13:43:41', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'atc', 'distances', 'BASE TABLE', 'InnoDB', 10, 'Compact', 19, 862, 16384, 0, 16384, 6291456, NULL, '2013-11-02 20:08:30', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'atc', 'ports', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 6291456, NULL, '2013-11-02 20:05:42', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'laboratorydb', 'faculties', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 6291456, 3, '2013-03-23 20:58:46', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'laboratorydb', 'universities', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 6291456, 1, '2013-03-23 20:58:43', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'motorbikes', 'bike_images', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 6291456, 2, '2013-11-02 17:02:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'motorbikes', 'bikes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 65536, 6291456, 14, '2013-11-02 14:15:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'motorbikes', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 6291456, 3, '2013-11-02 14:20:28', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
...
('def', 'startrek', 'crew', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 12, 51, 684, 281474976710655, 3072, 64, 25, '2008-01-05 02:08:39', '2008-01-13 10:16:40', NULL, 'latin1_general_ci', NULL, '', ''),
('def', 'startrek', 'login', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 3072, 0, 4, '2008-01-02 21:47:51', '2008-01-02 20:47:50', '2008-01-03 19:42:37', 'latin1_general_ci', NULL, '', ''),
('def', 'startrek', 'service', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 19, 10, 190, 2814749767106559, 3072, 0, NULL, '2008-01-05 02:10:52', '2008-01-13 10:16:40', '2008-01-12 22:38:33', 'latin1_general_ci', NULL, '', ''),
('def', 'startrek', 'ships', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 9, 62, 620, 281474976710655, 3072, 60, 31, '2008-01-05 02:08:50', '2008-01-13 10:16:40', NULL, 'latin1_general_ci', NULL, '', ''),
('def', 'users', 'bikes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 6291456, 10, '2013-03-10 14:01:26', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'users', 'members', 'BASE TABLE', 'InnoDB', 10, 'Compact', 12, 1365, 16384, 0, 0, 6291456, 13, '2013-03-09 19:46:23', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'users', 'shop', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 6291456, 11, '2013-03-10 07:30:47', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'laboratorydb', 'PRIMARY', 'laboratorydb', 'faculties', 'PRIMARY KEY'),
('def', 'laboratorydb', 'PRIMARY', 'laboratorydb', 'universities', 'PRIMARY KEY'),
('def', 'laboratorydb', 'universities_ibfk_1', 'laboratorydb', 'universities', 'FOREIGN KEY'),
('def', 'motorbikes', 'PRIMARY', 'motorbikes', 'bike_images', 'PRIMARY KEY'),
('def', 'motorbikes', 'bike_images_ibfk_1', 'motorbikes', 'bike_images', 'FOREIGN KEY'),
('def', 'motorbikes', 'PRIMARY', 'motorbikes', 'bikes', 'PRIMARY KEY'),
('def', 'motorbikes', 'bikes_ibfk_3', 'motorbikes', 'bikes', 'FOREIGN KEY'),
('def', 'motorbikes', 'PRIMARY', 'motorbikes', 'users', 'PRIMARY KEY'),
...
('def', 'startrek', 'PRIMARY', 'startrek', 'crew', 'PRIMARY KEY'),
('def', 'startrek', 'name', 'startrek', 'crew', 'UNIQUE'),
('def', 'startrek', 'PRIMARY', 'startrek', 'login', 'PRIMARY KEY'),
('def', 'startrek', 'user_2', 'startrek', 'login', 'UNIQUE'),
('def', 'startrek', 'PRIMARY', 'startrek', 'ships', 'PRIMARY KEY'),
('def', 'startrek', 'name', 'startrek', 'ships', 'UNIQUE'),
('def', 'users', 'PRIMARY', 'users', 'bikes', 'PRIMARY KEY'),
('def', 'users', 'PRIMARY', 'users', 'members', 'PRIMARY KEY'),
('def', 'users', 'PRIMARY', 'users', 'shop', 'PRIMARY KEY');
...
--
CREATE DATABASE `laboratorydb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `laboratorydb`;
...
INSERT INTO `faculties` (`Code`, `NameFac`) VALUES
(1, 'DATNIG'),
(2, 'WWWWWWWWWW');
...
ALTER TABLE `universities`
  ADD CONSTRAINT `universities_ibfk_1` FOREIGN KEY (`Code`) REFERENCES `faculties` (`Code`);
--
-- Database: `members`
--
...
-- Database: `motorbikes`
--
CREATE DATABASE `motorbikes` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `motorbikes`;
...
INSERT INTO `bike_images` (`id`, `bikes_id`, `img`) VALUES
(1, 12, '/upload/whatever.jpg;upload/12/2013AnimalCalender-page-001.jpg');
...
INSERT INTO `bikes` (`id`, `users_id`, `username`, `firstname`, `lastname`, `model`, `year`, `info`) VALUES
(12, 1, 'Ahntrax', 'Elod', 'Szopos', 'Yamaha', 2011, 'nice'),
(13, 1, 'Ahntrax', 'Elod', 'Szopos', 'Yamaha', 2012, 'super');
...
INSERT INTO `users` (`id`, `admin`, `firstname`, `lastname`, `username`, `password`) VALUES
(1, 1, 'Elod', 'Szopos', 'Ahntrax', '5f4dcc3b5aa765d61d8327deb882cf99'),
(2, 0, 'Jackson', 'Whatever', 'Jackson', '5f4dcc3b5aa765d61d8327deb882cf99');
...
ALTER TABLE `bike_images`
  ADD CONSTRAINT `bike_images_ibfk_1` FOREIGN KEY (`bikes_id`) REFERENCES `bikes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `bikes`
--
ALTER TABLE `bikes`
  ADD CONSTRAINT `bikes_ibfk_3` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `mysql`
--
...
-- Database: `startrek`
--
CREATE DATABASE `startrek` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
USE `startrek`;
...
CREATE TABLE IF NOT EXISTS `crew` (
  ...
  `img` varchar(30) COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
...
INSERT INTO `crew` (`id`, `name`, `img`) VALUES
(1, 'James T. Kirk', 'kirk.jpg'),
(3, 'Jean-Luc Picard', 'picard.jpg'),
(4, 'William T. Riker', 'riker.jpg'),
(5, 'Benjamin L. Sisko', 'sisko.jpg'),
(6, 'Kira Nerys', 'kira.jpg'),
(7, 'Kathryn Janeway', 'janeway.jpg'),
(8, 'Chakotay', 'chakotay.jpg'),
(9, 'Jonathan Archer', 'archer.jpg'),
(10, 'Charles Tucker III', 'tucker.jpg'),
(11, 'Worf', 'worf.jpg'),
(12, 'Miles E. O''Brien', 'obrien.jpg'),
(24, 'Spock', 'Spock1.jpg');
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `pass` varchar(15) COLLATE latin1_general_ci NOT NULL,
...
INSERT INTO `service` (`crew_id`, `ship_id`, `cpt`) VALUES
(1, 1, 1),
(24, 1, 0),
(3, 5, 1),
(3, 4, 1),
...
INSERT INTO `ships` (`id`, `name`, `class`, `img`) VALUES
(1, 'Enterprise A', 'Constitution', 'ent_a.jpg'),
(2, 'Enterprise B', 'Excelsior', 'ent_b.jpg'),
(3, 'Enterprise C', 'Ambassador', 'ent_c.jpg'),
(4, 'Enterprise D', 'Galaxy', 'ent_d.jpg'),
(5, 'Enterprise E', 'Sovereign', 'ent_e.jpg'),
(6, 'Voyager', 'Intrepid', 'voy.jpg'),
(7, 'Deep Space 9', 'Cardassian station', 'ds9.jpg'),
(28, 'Enterprise NX', 'NX', 'GEnterprise2.jpg'),
(21, 'Stargazer', 'Constellation', 'GConstellation1.jpg');
--
-- Database: `test`
--
...
CREATE TABLE IF NOT EXISTS `bikes` (
  `bike_id` int(100) NOT NULL AUTO_INCREMENT,
  `C_bike_id` int(100) NOT NULL,
...
INSERT INTO `bikes` (`bike_id`, `C_bike_id`, `member_id`, `model`, `year`, `description`) VALUES
(1, 0, 1, 'CBR', '2004', 'Very nice'),
(4, 3, 1, 'Kawasaki', '2005', 'fff'),
(5, 4, 4, 'Awye', '2012', 'Sup'),
(6, 5, 4, 'DatBike', '2055', 'ggg'),
(7, 6, 1, 'Meh', '1999', 'All done y0.'),
(9, 8, 1, 'Y2K', '2013', 'Best br0.');
...
(1, 'Elod', 'Szopos', 'Ahntrax', '2393bdf438e72edaebd9dde79cb2ee7b'),
(2, 'Jackson', 'Ville', 'Jackson', '5f4dcc3b5aa765d61d8327deb882cf99'),
(3, 'Valaki', 'Valami', 'Valaki', '5f4dcc3b5aa765d61d8327deb882cf99'),
(4, 'Jack', 'Jack', 'Jack', '5f4dcc3b5aa765d61d8327deb882cf99'),
(5, 'Whatthehell', 'Whynot', 'Supbro', '0c00f34b2a3bd17d542b8a9db6137cd9'),
(6, 'Wadap', 'Wadap', 'Wadap', '25ed1bcb423b0b7200f485fc5ff71c8e'),
(7, 'Barni', 'Barni', 'Barni', '6c097cebf41bd249b01f172a38ae658b'),
(8, 'testin', 'testin', 'testin', '54835cf5b563a206fd5112aa828721d9'),
(9, 'testing', 'testing', 'testing', 'ae2b1fca515949e5d54fb22b8ed95575'),
(10, 'ff', 'fff', 'fff', '343d9040a671c45832ee5381860e2996'),
(11, 'Barni', 'Barni', 'Barney', '2393bdf438e72edaebd9dde79cb2ee7b'),
(12, 'ff', 'ff', 'asd', '7815696ecbf1c96e6894b779456d330e');
...
INSERT INTO `shop` (`bike_id`, `shop_id`, `member_id`, `model`, `year`, `email`, `state`) VALUES
(3, 1, 1, 'HONDA CBR', 2012, 'Ahntrax@hotmail.com', 'sadsad'),
(6, 3, 1, 'test', 2222, 'test@yahoo.com', 'vvvv'),
(7, 4, 4, 'ff', 22, 'ff@vv.com', 'ffff'),
(8, 5, 1, 'Barnis fav', 2013, 'b_a_r_n_i@yahoo.com', 'SUP NIG'),
(9, 6, 1, 'zz', 2222, 'grim_ahntrax@yahoo.com', 'datbike'),
(10, 7, 11, 'FZR', 2005, 'barnamumtyan@gmail.com', 'Very good.');
